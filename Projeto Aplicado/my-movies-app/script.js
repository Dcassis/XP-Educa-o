...
function movieNameParameterGenerator (){
  if(movieName.value === ' ') {
    throw new Error ('O nome do filme deve ser digitado')
  }
...
function isMovieAlreadyOnList(id) {
  function doesThisIdBelongToThisListMovie(movieObject){
    return movieObject.imdbID === id
  }
  return Boolean (movieList.find(doesThisIdBelongToThisListMovie))
